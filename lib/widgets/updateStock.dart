...
class Updatestock {
  static void show({
    ...
    final TextEditingController manualStockController =
    TextEditingController(text: stock.manualStock.toString());
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.inventory, color: brandColor),
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildInfoRow(
                              ...
                              stock.effectiveStock > 10 ? Colors.green : Colors.orange,
                            ),
                          ],
                        ),
                      ),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if (newStock == null) {
                          if (kDebugMode) {
                            print('[VALIDATION] Input bukan angka valid: "$inputText"');
                          }
